...
/**
 * RawJavaParser 变更性质判断测试
 * 用例设计与 {@link JavaParserChangeNatureTest} 保持一致。
 */
public class RawJavaParserChangeNatureTest {
    ...
    void setUp() {
        ...
        RawLanguageParser.registerCommonConfigs(configMap);
        parser = new RawJavaParser(configMap);
    }
